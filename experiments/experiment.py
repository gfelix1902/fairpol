...
def perform_experiment(config, fixed_params=None):
    ...
    for run_index in range(runs):
        ...
        try:
            ...
            policy_values_cond = model_evaluation.get_table_pvalues_conditional(trained_models, datasets["d_test"], data_type=config_data["dataset"], covariate_cols=config_data["covariate_cols"])
